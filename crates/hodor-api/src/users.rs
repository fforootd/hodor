...
async fn set_password(
    ...
    let cred_json = hodor_auth::password::encode_credential_json(&hash);
...
async fn load_user(scoped: &hodor_db::scoped::ScopedDb, id: &str) -> anyhow::Result<Option<UserResponse>> {
