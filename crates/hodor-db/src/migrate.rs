...
const SQLITE_MIGRATIONS: &[(&str, &str)] = &[
    ("00001_initial", include_str!("../../../internal/database/migrations/sqlite/00001_initial.sql")),
    ("00002_instance_id", include_str!("../../../internal/database/migrations/sqlite/00002_instance_id.sql")),
];

const POSTGRES_MIGRATIONS: &[(&str, &str)] = &[
    ("00001_initial", include_str!("../../../internal/database/migrations/postgres/00001_initial.sql")),
    ("00002_instance_id", include_str!("../../../internal/database/migrations/postgres/00002_instance_id.sql")),
];
...
mod tests {
    ...
    fn test_split_actual_migration() {
        let sql = include_str!("../../../internal/database/migrations/sqlite/00001_initial.sql");
