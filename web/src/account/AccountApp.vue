<template>
  <div class="min-h-screen bg-background">
    ...
    <main class="mx-auto max-w-3xl px-4 py-6">
      <!-- Loading -->
      <div v-if="!profile && !loadError" class="flex justify-center py-16">
        <Spinner class="size-6" />
      </div>

      <!-- Error -->
      <Card v-if="loadError" class="py-12 text-center">
        <CardContent>
          <h2 class="text-lg font-semibold mb-2">Session expired</h2>
          <p class="text-sm text-muted-foreground">Please <a href="/login" class="text-primary underline">sign in</a> to access your account.</p>
        </CardContent>
      </Card>
