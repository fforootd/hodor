...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/applications',
      name: 'applications',
      component: () => import('./views/UnifiedAppsView.vue'),
    },
    {
    ...
    },
    {
      ...
      component: () => import('./views/ProviderCreateView.vue'),
    },
    {
      path: '/providers/:id',
    ...
    },
    {
      path: '/api-protocols',
      name: 'api-protocols',
      component: () => import('./views/ApiProtocolsView.vue'),
    },
    ...
    { path: '/jobs', name: 'jobs', component: () => import('./views/JobsView.vue') },
    {
      path: '/observability',
      name: 'obs-overview',
      component: () => import('./views/observability/OverviewView.vue'),
    },
    {
      path: '/observability/explore',
      name: 'obs-explore',
      component: () => import('./views/observability/ExploreView.vue'),
    },
    {
      path: '/traces',
      name: 'traces',
      component: () => import('./views/observability/TracesView.vue'),
    },
    {
      path: '/fingerprints',
      name: 'fingerprints',
      component: () => import('./views/observability/FingerprintListView.vue'),
    },
    ...
    },
    {
      ...
      component: () => import('./views/authorization/RelationshipsView.vue'),
    },
    {
      path: '/authorization/model',
      name: 'authz-model',
      component: () => import('./views/authorization/ModelView.vue'),
    },
    {
      path: '/authorization/modules',
      name: 'authz-modules',
      component: () => import('./views/authorization/ModulesView.vue'),
    },
    // Backward compat
    ...
    // Login Flow editor with live preview
    {
      path: '/login-flows',
      name: 'login-flows',
      component: () => import('./views/LoginFlowListView.vue'),
    },
    {
      path: '/login-flows/:id',
