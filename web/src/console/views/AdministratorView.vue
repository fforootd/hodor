<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-semibold tracking-tight">FGA Administrator</h1>
        <p class="text-sm text-muted-foreground mt-1">
          Internal OpenFGA management — model graph, tuple browser, and authorization playground.
        </p>
      </div>
