<template>
  <div class="space-y-6">
    ...
    <ResourceCreateSheet
      ...
      description="Define the project with schema fields, inspect its JSON, or copy the request cURL."
      schema-type="project"
      api-path="/v1/projects"
      resource-label="Project"
      :include-org-header="true"
      :create-fn="(payload) => projectApi.create(payload)"
      @created="onCreated"
    />
  </div>
</template>
