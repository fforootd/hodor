...
func TestMigrate(t *testing.T) {
	...
	err = db.SQL().QueryRow("SELECT name FROM sqlite_master WHERE type='table' AND name='entity_capabilities'").Scan(&name)
	if err != nil {
		t.Fatalf("entity_capabilities table not found: %v", err)
	}
